...
class EcmwfAifsSingleInternalAttrs(BaseInternalAttrs):
    """
...
class EcmwfAifsSingleDataVar(DataVar[EcmwfAifsSingleInternalAttrs]):
    pass


class EcmwfAifsSingleForecastVirtualSpatialTemplateConfig(TemplateConfig[EcmwfAifsSingleDataVar]):
    ...
    @computed_field
    @property
    def data_vars(self) -> Sequence[EcmwfAifsSingleDataVar]:
        ...
        #         ),
        #         internal_attrs=EcmwfAifsSingleInternalAttrs(
        #             grib_element="TMP",
        #         ),
        #     ),
        #     EcmwfAifsSingleDataVar(
