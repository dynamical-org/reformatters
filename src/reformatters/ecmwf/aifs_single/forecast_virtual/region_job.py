...
from .template_config import EcmwfAifsSingleDataVar
...
class EcmwfAifsSingleForecastVirtualSpatialSourceFileCoord(SourceFileCoord):
    ...
    # init_time: Timestamp
    # lead_time: Timedelta
    # data_vars: Sequence[EcmwfAifsSingleDataVar]
...
class EcmwfAifsSingleForecastVirtualSpatialRegionJob(
    VirtualRegionJob[EcmwfAifsSingleDataVar, EcmwfAifsSingleForecastVirtualSpatialSourceFileCoord]
):
    def generate_source_file_coords(
        self, processing_region_ds: xr.Dataset, data_var_group: Sequence[EcmwfAifsSingleDataVar]
    ) -> Sequence[EcmwfAifsSingleForecastVirtualSpatialSourceFileCoord]:
        ...
        """
        # return [
        #     EcmwfAifsSingleForecastVirtualSpatialSourceFileCoord(
    ...
    def discover_available(
        self, pending: list[EcmwfAifsSingleForecastVirtualSpatialSourceFileCoord]
    ) -> list[tuple[EcmwfAifsSingleForecastVirtualSpatialSourceFileCoord, int]]:
    ...
    def file_refs(
        self, coord: EcmwfAifsSingleForecastVirtualSpatialSourceFileCoord, file_size: int
    ) -> list[VirtualRef]:
    ...
    #
    # def representative_var(self, coord: EcmwfAifsSingleForecastVirtualSpatialSourceFileCoord) -> EcmwfAifsSingleDataVar:
