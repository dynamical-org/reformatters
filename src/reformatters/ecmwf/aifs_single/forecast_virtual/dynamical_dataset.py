...
class EcmwfAifsSingleForecastVirtualDataset(
    ...
    def operational_kubernetes_resources(self, image_tag: str) -> Sequence[CronJob]:
        ...
        # a ~2 minute burst ~init+5h25m to init+6h03m (p99 ~init+6h10m; the GCS
        # mirror trails S3 by under a minute). Fire at init+5h20m and poll; the 1h
        # deadline covers p99, bounds waiting on a cycle that never publishes, and
        # keeps fires from overlapping.
