...
from .region_job import EcmwfAifsSingleForecastVirtualSpatialRegionJob, EcmwfAifsSingleForecastVirtualSpatialSourceFileCoord

# from .region_job import _SOURCE_PREFIX, _SOURCE_REGION
from .template_config import EcmwfAifsSingleDataVar, EcmwfAifsSingleForecastVirtualSpatialTemplateConfig


class EcmwfAifsSingleForecastVirtualSpatialDynamicalDataset(
    DynamicalDataset[EcmwfAifsSingleDataVar, EcmwfAifsSingleForecastVirtualSpatialSourceFileCoord]
):
    template_config: EcmwfAifsSingleForecastVirtualSpatialTemplateConfig = EcmwfAifsSingleForecastVirtualSpatialTemplateConfig()
    region_job_class: type[EcmwfAifsSingleForecastVirtualSpatialRegionJob] = EcmwfAifsSingleForecastVirtualSpatialRegionJob
