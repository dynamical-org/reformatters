...
class NoaaHrrrCommonTemplateConfig(TemplateConfig[NoaaHrrrDataVar]):
    ...
    def get_data_vars(self, encoding: Encoding) -> Sequence[NoaaHrrrDataVar]:
        ...
        return [
            ...
            NoaaHrrrDataVar(
                name="friction_velocity_surface",
                encoding=encoding,
                attrs=DataVarAttrs(
                    short_name="zust",
            ...
            NoaaHrrrDataVar(
                name="upward_long_wave_radiation_flux_surface",
                encoding=encoding,
                attrs=DataVarAttrs(
                    short_name="sulwrf",
            ...
            NoaaHrrrDataVar(
                name="visible_diffuse_downward_solar_flux_surface",
                encoding=encoding,
                attrs=DataVarAttrs(
                    short_name="vddsf",
