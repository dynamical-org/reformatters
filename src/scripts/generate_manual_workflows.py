        ...
        "on": {
            "workflow_dispatch": {
                "inputs": {
                    ...
                    "filter_contains": {
                        "description": "Comma-separated append-dim timestamps (ISO, optional) to process only the regions whose jobs touch them — the most efficient way to re-backfill specific flagged positions.",
                        "required": False,
                        "type": "string",
                    },
