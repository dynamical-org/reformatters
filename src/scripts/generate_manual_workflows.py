...
echo "### Monitoring"
echo ""
echo "- Better Stack heartbeats (filter for ${CRONJOB_NAME}.start / .complete): https://uptime.betterstack.com/"
echo "- Better Stack logs (filter job_name=${JOB_NAME}): https://telemetry.betterstack.com/"
...
# Write to job summary
{
  ...
  echo "### Monitoring"
  echo ""
  echo "- [Better Stack heartbeats](https://uptime.betterstack.com/) (filter for \`${CRONJOB_NAME}.start\` / \`.complete\`)"
  echo "- [Better Stack logs](https://telemetry.betterstack.com/) (filter \`job_name=${JOB_NAME}\`)"
  echo "- [Manual Get Jobs](https://github.com/${{ github.repository }}/actions/workflows/manual-get-jobs.yml)"
  echo "- [Manual Get Pods](https://github.com/${{ github.repository }}/actions/workflows/manual-get-pods.yml)"
} >> $GITHUB_STEP_SUMMARY
"""
