...
| PR 4 — first concrete virtual dataset | **open** (#656) | `noaa-gefs-forecast-10-day-spatial`: 4 inits/day, 0-240h, native 0.25° s-file grid, the 35-day vars available in s files (19). |
