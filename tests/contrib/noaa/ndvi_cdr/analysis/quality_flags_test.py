...
@pytest.mark.parametrize(
    ...
    [
        ...
        (VIIRS_COASTAL, True),
        (VIIRS_LAND_WATER_BIT_4 + VIIRS_AEROSOL_QUALITY_OK, True),
        ...
        (VIIRS_LAND_WATER_BIT_3, True),
        (VIIRS_LAND_WATER_BIT_3 + VIIRS_AEROSOL_QUALITY_OK, False),
    ],
    ids=[
        "fill-value",
        "inland-water",
