...
# from reformatters.noaa.ndvi_cdr.analysis.dynamical_dataset import NoaaNdviCdrAnalysisDataset

# @pytest.mark.slow
# def test_backfill_local_and_operational_update(monkeypatch: pytest.MonkeyPatch) -> None:
#     dataset = NoaaNdviCdrAnalysisDataset()
...
# def test_validators(dataset: NoaaNdviCdrAnalysisDataset) -> None:
