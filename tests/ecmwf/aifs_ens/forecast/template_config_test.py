...
def test_template_config_attrs() -> None:
    ...
    assert config.append_dim_start == pd.Timestamp("2025-07-02T00:00")
...
def test_dataset_attributes() -> None:
    cfg = EcmwfAifsEnsForecastTemplateConfig()
    attrs = cfg.dataset_attributes
    assert attrs.dataset_id == "ecmwf-aifs-ens-forecast"
