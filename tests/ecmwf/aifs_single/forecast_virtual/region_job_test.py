...
#     EcmwfAifsSingleForecastVirtualSpatialRegionJob,
#     EcmwfAifsSingleForecastVirtualSpatialSourceFileCoord,
# )
# from reformatters.ecmwf.aifs_single.forecast_virtual.template_config import EcmwfAifsSingleForecastVirtualSpatialTemplateConfig


# def test_source_file_coord_url_uses_container_prefix() -> None:
#     coord = EcmwfAifsSingleForecastVirtualSpatialSourceFileCoord(
...
#     template_config = EcmwfAifsSingleForecastVirtualSpatialTemplateConfig()
#     template_ds = template_config.get_template(pd.Timestamp("2020-01-02"))

#     region_job = EcmwfAifsSingleForecastVirtualSpatialRegionJob(
#         tmp_store=Mock(),
