...
# from reformatters.ecmwf.aifs_single.forecast_virtual.dynamical_dataset import EcmwfAifsSingleForecastVirtualSpatialDynamicalDataset
# from tests.common.dynamical_dataset_test import assert_configured_validators


# @pytest.fixture
# def dataset(tmp_path: Path) -> EcmwfAifsSingleForecastVirtualSpatialDynamicalDataset:
#     # A virtual dataset's primary store must be ICECHUNK, and icechunk_virtual_config
#     # (set on EcmwfAifsSingleForecastVirtualSpatialDynamicalDataset) registers the source buckets the refs may point into.
#     return EcmwfAifsSingleForecastVirtualSpatialDynamicalDataset(
...
#     monkeypatch: pytest.MonkeyPatch, dataset: EcmwfAifsSingleForecastVirtualSpatialDynamicalDataset
# ) -> None:
...
# def test_operational_kubernetes_resources(dataset: EcmwfAifsSingleForecastVirtualSpatialDynamicalDataset) -> None:
...
# def test_validators_include_virtual_checks(dataset: EcmwfAifsSingleForecastVirtualSpatialDynamicalDataset) -> None:
