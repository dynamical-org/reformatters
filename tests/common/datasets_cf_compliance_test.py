...
CF_UNITS_VARIANCES_ALLOWLIST: set[tuple[str, str]] = {
    ...
    # HRRR turbulent kinetic energy carries GRIB's J kg-1; CF canonical is m2 s-2.
    ("specific_turbulent_kinetic_energy_of_air", "J kg-1"),
...
CROSS_DATASET_CONSISTENCY_EXCEPTIONS: set[tuple[str, str, str]] = {
    ...
    ("wind_u_10m", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("wind_v_10m", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("wind_u_80m", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("wind_v_80m", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("wind_u", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("wind_v", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("10u", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("10v", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("80u", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("80v", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("u", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("v", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("U component of wind", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("V component of wind", "standard_name", "noaa-hrrr-forecast-18-hour-virtual-fast"),
    ...
    ("ice_cover_surface", "flag_values", "noaa-gfs-forecast-virtual"),
    ("ice_cover_surface", "flag_meanings", "noaa-gfs-analysis-virtual"),
    ("ice_cover_surface", "flag_meanings", "noaa-gfs-forecast-virtual"),
    ...
    ("categorical_ice_pellets_surface", "step_type", "noaa-gfs-forecast-virtual"),
    ...
    ("categorical_freezing_rain_surface", "step_type", "noaa-gfs-forecast-virtual"),
    ...
    ("total_cloud_cover_atmosphere", "step_type", "noaa-gfs-forecast-virtual"),
    ...
    ("latent_heat_flux_surface", "step_type", "noaa-gfs-forecast-virtual"),
    ("sensible_heat_flux_surface", "step_type", "noaa-gfs-analysis-virtual"),
    ("sensible_heat_flux_surface", "step_type", "noaa-gfs-forecast-virtual"),
