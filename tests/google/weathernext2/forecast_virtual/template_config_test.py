...
# from reformatters.google.weathernext2.forecast_virtual.template_config import GoogleWeathernext2ForecastVirtualSpatialTemplateConfig
...
#     config = GoogleWeathernext2ForecastVirtualSpatialTemplateConfig()
