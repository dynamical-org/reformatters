...
# from reformatters.google.weathernext2.forecast_virtual.dynamical_dataset import GoogleWeathernext2ForecastVirtualSpatialDynamicalDataset
# from tests.common.dynamical_dataset_test import assert_configured_validators


# @pytest.fixture
# def dataset(tmp_path: Path) -> GoogleWeathernext2ForecastVirtualSpatialDynamicalDataset:
#     # A virtual dataset's primary store must be ICECHUNK, and icechunk_virtual_config
#     # (set on GoogleWeathernext2ForecastVirtualSpatialDynamicalDataset) registers the source buckets the refs may point into.
#     return GoogleWeathernext2ForecastVirtualSpatialDynamicalDataset(
...
#     monkeypatch: pytest.MonkeyPatch, dataset: GoogleWeathernext2ForecastVirtualSpatialDynamicalDataset
# ) -> None:
...
# def test_operational_kubernetes_resources(dataset: GoogleWeathernext2ForecastVirtualSpatialDynamicalDataset) -> None:
...
# def test_validators_include_virtual_checks(dataset: GoogleWeathernext2ForecastVirtualSpatialDynamicalDataset) -> None:
