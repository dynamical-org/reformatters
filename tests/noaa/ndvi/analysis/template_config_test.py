...
from reformatters.noaa.ndvi.analysis.template_config import (
    NoaaNdviAnalysisTemplateConfig,
)
...
def test_update_template(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    ...
    all changes to NoaaNdviAnalysisTemplateConfig are reflected in the on-disk Zarr template.
    """
