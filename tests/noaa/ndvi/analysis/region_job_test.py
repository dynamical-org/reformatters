...
# from reformatters.noaa.ndvi.analysis.region_job import (
#     NoaaNdviAnalysisRegionJob,
#     NoaaNdviAnalysisSourceFileCoord,
# )
# from reformatters.noaa.ndvi.analysis.template_config import NoaaNdviAnalysisTemplateConfig

# def test_source_file_coord_get_url() -> None:
#     coord = NoaaNdviAnalysisSourceFileCoord(time=pd.Timestamp("2000-01-01"))
#     assert coord.get_url() == "https://example.com/data/2000-01-01.grib2"


# def test_region_job_generete_source_file_coords() -> None:
#     template_config = NoaaNdviAnalysisTemplateConfig()
#     template_ds = template_config.get_template(pd.Timestamp("2000-01-23"))

#     region_job = NoaaNdviAnalysisRegionJob(
#         final_store=Mock(),
#         tmp_store=Mock(),
