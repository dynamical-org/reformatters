...
# #     rtol = 0.0
# #     assert np.isclose(
# #         bounds.left + pixel_size_x / 2, lon.min(), atol=atol, rtol=rtol
# #     )
# #     assert np.isclose(
# #         bounds.right - pixel_size_x / 2, lon.max(), atol=atol, rtol=rtol
# #     )
# #     assert np.isclose(
# #         bounds.top - pixel_size_y / 2, lat.max(), atol=atol, rtol=rtol
# #     )
# #     assert np.isclose(
# #         bounds.bottom + pixel_size_y / 2, lat.min(), atol=atol, rtol=rtol
# #     )
